    ...
    <>
      ...
      <nav className="navbar">
        ...
        <div className="navbar-right navbar-desktop">
          <button
            className={`navbar-button ${isActive("/my-tasks") ? "navbar-button-active" : ""}`}
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M13 14L17 10L13 6M17 10H7M7 17H4C3.46957 17 2.96086 16.7893 2.58579 16.4142C2.21071 16.0391 2 15.5304 2 15V5C2 4.46957 2.21071 3.96086 2.58579 3.58579C2.96086 3.21071 3.46957 3 4 3H7"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <div className={`navbar-mobile ${isMobileMenuOpen ? "open" : ""}`}>
        ...
        <div className="navbar-mobile-menu">
          ...
          <button
            className={`navbar-mobile-button ${isActive("/my-tasks") ? "active" : ""}`}
            onClick={() => handleNavigation("/my-tasks")}
          >
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
