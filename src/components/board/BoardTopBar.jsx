...
function BoardTopBar({
  ...
  // Store
  const { sendInvite, leaveBoard, deleteBoard, pendingMembers } = useBoardPageStore()
    ...
    <>
      <div className="board-topbar">
        ...
        <div className="board-topbar-left">
          ...
          <div className="board-info">
            ...
            {boardLeader && (
              <span className="board-leader">Led by {boardLeader.userName}</span>
            )}
          </div>
        </div>
              ...
              <div className="topbar-dropdown">
                ...
                */}
                ...
                {isAdmin ? (
                  ...
                  <>
                    <div className="dropdown-divider"></div>
                    <button className="dropdown-item dropdown-item-danger" onClick={handleLeaveClick}>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      {showRenameModal && (
        <RenameBoardModal
          ...
          onSuccess={(newName) =>
            setToast({ message: `Board renamed to "${newName}"`, type: "success" })
          }
        />
      )}
